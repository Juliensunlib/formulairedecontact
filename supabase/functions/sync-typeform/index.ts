...
const corsHeaders = {
  ...
  'Access-Control-Allow-Headers': 'Content-Type, Authorization, X-Client-Info, Apikey, X-Typeform-Token, X-Airtable-Token, X-Airtable-Base-Id, X-Airtable-Table-Name, apikey',
};
