    ...
    for (const response of responses) {
      try {
        ...
        const responseData = {
          ...
          nom: extractFieldValue(answers, "nom"),
          prenom: extractFieldValue(answers, "prenom"),
          email: extractFieldValue(answers, "email"),
          telephone: extractFieldValue(answers, "telephone"),
          entreprise: extractFieldValue(answers, "entreprise"),
          secteur: extractFieldValue(answers, "secteur"),
          besoin: extractFieldValue(answers, "besoin"),
